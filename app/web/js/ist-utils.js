...
// Format UTC string to IST time "h:mm am/pm IST" (12-hour format)
...
// Format UTC string to full IST date and time "26 Jul 2025, 6:06 pm IST"
...
// Usage example: Show IST time in check-in field
document.getElementById('checkInTime').textContent = record.check_in 
    ? formatISTDateTime(record.check_in) 
    : 'Not checked in';


document.getElementById('checkInTime').textContent = record.check_in ? formatISTDateTime(record.check_in) : 'Not checked in';
